...
export const AuthProvider = ({ children }) => {
  ...
  const loginWithTelegram = async (telegramAuthData) => {
    try {
      const telegramData = {
        provider: 'telegram',
        provider_user_id: String(telegramAuthData.id ?? ''),
        access_token: telegramAuthData.hash || '',
        ...
        auth_date: telegramAuthData.auth_date != null
          ? String(telegramAuthData.auth_date)
          : null,
      };
      if (telegramAuthData.init_data) {
        telegramData.init_data = telegramAuthData.init_data;
      }
