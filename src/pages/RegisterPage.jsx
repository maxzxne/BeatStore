...
const RegisterPage = () => {
  ...
  const fieldClass =
    'w-full rounded-xl border border-white/10 bg-white/5 py-2.5 pl-10 pr-4 text-sm text-white placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-[#22c55e]/40';
  const oauthBtnClass =
    'flex h-12 w-full items-center justify-center rounded-full border border-white/15 bg-white/[0.03] px-4 text-base text-white transition hover:bg-white/5 disabled:cursor-not-allowed disabled:opacity-50';

  return (
    <div className="flex min-h-screen items-center justify-center bg-[#050505] px-4 py-10">
      <div className="w-full max-w-md">
        <Link to="/" className="mb-4 inline-flex items-center text-sm text-white/60 transition-colors hover:text-white">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 sm:p-8">
          <div className="mb-6 text-center">
            ...
            <h1 className="mt-2 font-[Syne] text-3xl font-extrabold text-white">Регистрация</h1>
            <p className="mt-2 text-sm text-white/50">Создайте новый аккаунт</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="register_email" className="mb-2 block text-sm font-medium text-white/80">
                Email
              </label>
              <div className="relative">
                <Mail className="pointer-events-none absolute left-3 top-1/2 z-10 h-4 w-4 -translate-y-1/2 text-white/40" />
                <input
                  type="email"
                  id="register_email"
                  name="email"
            ...
            <div>
              <label htmlFor="register_username" className="mb-2 block text-sm font-medium text-white/80">
                Имя пользователя
              </label>
              <div className="relative">
                <User className="pointer-events-none absolute left-3 top-1/2 z-10 h-4 w-4 shrink-0 -translate-y-1/2 text-white/40" />
                <input
                  type="text"
            ...
            <div>
              <label htmlFor="register_password" className="mb-2 block text-sm font-medium text-white/80">
                Пароль
              </label>
              <div className="relative">
            ...
            <div>
              <label htmlFor="register_confirmPassword" className="mb-2 block text-sm font-medium text-white/80">
                Подтвердите пароль
              </label>
              <div className="relative">
                <Lock className="pointer-events-none absolute left-3 top-1/2 z-10 h-4 w-4 -translate-y-1/2 text-white/40" />
              ...
              <label className="flex items-start gap-2 text-xs text-white/50">
                ...
                <span>
                  ...
                  <a
                    ...
                    className="text-[#22c55e] underline hover:brightness-110"
                  >
          ...
          {!oauthSettingsLoading && (
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-[#0a0a0a] px-2 text-white/40">Или зарегистрируйтесь через</span>
              </div>
            </div>
          )}
