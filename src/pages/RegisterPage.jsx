      ...
      <div className="max-w-md w-full mx-4">
        ...
        <div className="card">
          <div className="card-header text-center">
            ...
            <p className="text-gray-600 dark:text-neutral-400">Создайте новый аккаунт</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="card-content space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-500 dark:text-neutral-400" />
                <input
                  type="email"
                  id="register_email"
                  name="email"
          ...
          {!oauthSettingsLoading && (
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-neutral-900 text-gray-500 dark:text-neutral-400">Или зарегистрируйтесь через</span>
              </div>
            </div>
          )}
