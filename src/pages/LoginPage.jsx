      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="login_password" className="mb-2 block text-sm font-medium text-white/80">
                Пароль
              </label>
              <div className="relative">
          ...
          {!pending2fa && !oauthSettingsLoading && (
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-[#0a0a0a] px-2 text-white/40">Или войдите через</span>
              </div>
            </div>
          )}
            ...
            {oauthSettings.telegram && !oauthSettings.telegram.is_hidden && (
              <button
                onClick={() => {
                  ...
                  setError('Открой магазин в Telegram — вход пройдёт автоматически.');
                }}
