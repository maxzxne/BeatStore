...
export const guideSections = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'tip',
        text: 'Ставку ₽/день и очередь заявок правите здесь (вкладка «Заявки»). Скидку на рекламу — в «Скидки» (scope ads).',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'Отдельный раздел: сроки и суммы для формы «Я знаю, что хочу». Не путать со ставкой рекламы (Баннеры → Заявки).',
      },
      {
        type: 'ul',
        items: [
          'Вкладка «Цены» — таблица дней / подпись / 50% / 100% + фикс трэп-бита (source of truth)',
          'Вкладка «Тексты» — подписи плашки и блоков; суммы не вбивать руками — превью подставляет из таблицы',
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'Маршрут называется oauth-settings исторически: видимость разделов, безопасность и OAuth. Прайс услуг и ставка рекламы сюда не входят.',
      },
      {
        type: 'ul',
        items: [
          ...
          'Ссылки-напоминания: Прайс услуг → /admin/pricing; реклама → Баннеры → Заявки',
