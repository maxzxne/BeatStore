...
export const guideSections = [
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Чекбокс «На полный экран»: вкл — крупная карточка 16:9 (до ~930 px, без краешка следующего, стрелки на карточке); выкл — компакт ~70% + краешек следующего (отступ 24px), тоже 16:9. Креативы лучше готовить под 16:9.',
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'Область «Реклама на витрине» режет расчёт дни×ставка на /order/ads до апрува. «Все товары» на рекламу не действует. На чекауте после апрува применяется только промокод.',
      },
      {
        type: 'warn',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Кнопка hero при необходимости ведёт на / или якорь каталога',
