...
export const guideSections = [
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'Сводка за 30 дней: пользователи, биты, покупки и доход по битам. Карточки кликабельны — ведут в соответствующий раздел. Ниже — типы покупок и лента по дням (покупки / регистрации).',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: 'steps',
        items: [
          'Создайте баннер: картинка, заголовок, ссылка (link_url), порядок.',
          'Задайте даты активности.',
          'Включите enabled.',
          'Чекбокс «На полный экран»: вкл — широкий 16:9; выкл — ниже/уже и справа всегда peek следующего слайда.',
          'Проверьте главную: клик по баннеру со ссылкой открывает URL. Свайп/drag не открывает ссылку.',
        ],
      },
      {
        type: 'tip',
        text: 'Без link_url баннер только показывает картинку. Истёкший баннер лучше выключить или удалить.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'Журнал ошибок с фильтром по дате и типу (auth / registration / purchase / payment), статистика и детали записи. Раскрытие строки пишет ?id= в URL — можно шарить ссылку на конкретную ошибку.',
      },
      {
        type: 'tip',
