...
export const ADMIN_GUIDE_VERSION = '2026-03-21';
...
export const guideSections = [
  ...
  },
  {
    ...
    group: 'Обзор',
    adminPath: '/admin/dashboard',
    keywords: ['kpi', 'аналитика', 'dashboard'],
    blocks: [
      {
        type: 'p',
        text: 'Сводка: число пользователей, битов, покупок и выручка. Ниже — разбивка типов покупок и графики регистраций/покупок за 30 дней.',
      },
      {
        type: 'ul',
        items: [
          'Раздел только для чтения — здесь ничего не редактируется.',
          'Детальная выручка с фильтрами — в «Доходы».',
          'Список конкретных покупок — в «Покупки».',
        ],
      },
    ],
  },
  {
    ...
    keywords: ['выручка', 'contributor', 'период', 'отчёт'],
    blocks: [
      {
        type: 'p',
        text: 'Аналитика выручки за период. Можно отфильтровать по бенефициару (contributor) — кому атрибутирован бит.',
      },
      {
        type: 'steps',
        items: [
          'Задайте start/end даты.',
          'При необходимости выберите человека из списка contributors.',
          'Смотрите разбивку по типам продуктов (биты / курсы / услуги и т.д.).',
        ],
      },
      {
        type: 'tip',
        text: '«Люди» (contributors) — это не роли админов и не аккаунты витрины сами по себе, а справочник бенефициаров для атрибуции дохода и сабмитов.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'Операционка service-заказов с витрины /order (и /order/ads, если реклама включена). Категории и прайс-матрица услуг на витрине сейчас в коде, не в CMS.',
      },
      {
        type: 'h3',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Тред появляется здесь; отвечаете сообщением.',
          'Можно создать тред из карточки пользователя.',
        ],
      },
      {
        type: 'tip',
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: 'Промо-слайдер на главной. Полный CRUD, загрузка картинки, окно starts_at / ends_at, статусы Active / Soon / Expired / Off.',
      },
      {
        type: 'steps',
        items: [
          'Создайте баннер: картинка, заголовок, ссылка, порядок.',
          'Задайте даты активности.',
          'Включите enabled.',
          'Проверьте главную в нужном окне дат.',
        ],
      },
      {
        type: 'tip',
        text: 'Истёкший баннер лучше выключить или удалить, чтобы не копить шум в админ-списке.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'OAuth Google / VK / Yandex / Telegram — hide или disable провайдера',
        ],
      },
      {
        type: 'warn',
  ...
  },
  {
    ...
    keywords: ['лог', 'auth', 'payment', 'debug'],
    blocks: [
      {
        type: 'p',
        text: 'Журнал ошибок с фильтром по дате и типу (auth / registration / purchase / payment), статистика и детали записи.',
      },
      {
        type: 'tip',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Гость может класть биты в guest cart, но checkout и favorite требуют аккаунт',
        ],
      },
      {
        type: 'h3',
    ...
    blocks: [
      {
        type: 'ul',
        items: [
          '«Знаю что нужно» — wizard с шагами и прайсом из кода',
