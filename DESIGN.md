...
Бэкенд принимает только **JPEG / PNG / WebP**, макс. **10 МБ**. SVG и HEIC не проходят.

Для V3 грузи **квадрат 1400×1400 или 2000×2000**, JPEG или WebP **до 400 КБ**. Не 4K PNG.

Кадр: stage — `object-fit: cover` + `object-position: 20% center` (левый край важнее центра). Каталог и мини-плеер режут в квадрат 48–72px. Композируй лицо/логотип ближе к левой трети, не в мёртвый центр.
